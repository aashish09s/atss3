        ...
        {sent ? (
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="bg-gray-50 rounded-lg p-3 border border-gray-200 text-xs text-gray-500">
              📧 A professional email will be sent with the assessment link. The link expires in <strong>7 days</strong>.
            </div>
            ...
            <div className="flex space-x-3 pt-1">
              ...
              <button onClick={handleSend} disabled={loading}
                ...
                {loading ? <><div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin"></div><span>Sending...</span></> 
                         : <><PaperAirplaneIcon className="w-4 h-4" /><span>Send Assessment</span></>}
              </button>
            </div>
          </div>
        )}
